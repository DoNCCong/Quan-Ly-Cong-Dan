...
namespace QuanLyCDTP
{
    public class CongDan
    {
        ...
        public CongDan(string cccd, string hoten, string gioitinh, string ngaysinh, string quequan
        ...
        public CongDan(string cccd, string hoten, string ngaysinh, string thuongtru)
        {
            this.cccd = cccd.Trim();
            this.hoten = hoten.Trim();
            this.ngaysinh = ngaysinh.Trim();
