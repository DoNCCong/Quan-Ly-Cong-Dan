...
namespace QuanLyCDTP
{
    public class KhaiSinh
    {
        ...
        public KhaiSinh(string id, string hoten, string gioitinh, DateTime ngayThangNamSinh, string dantoc, string quoctich, string noisinh, string hotencha, string dantoccha, string quoctichcha, string hotenme, string dantocme, string quoctichme, string nguoidangky,string cccdcha,string cccdme,DateTime ngaythangnamdk,string cccdcanbo)
        {
            this.id = id.Trim();
